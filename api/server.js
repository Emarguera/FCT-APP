...
var db = mongoose.connection,
    dburl = 'mongodb://bluedevs:Bluedevs01@ds053438.mlab.com:53438/db_bluedevs_fct',
    port = 3000;
...
var index = require('./index');
    ...
    academyRoutes = require('./components/academys/academys.route'),
    placeRoutes = require('./components/places/places.route'),
    associationRoutes = require('./components/associations/associations.route'),
    sponsorRoutes = require('./components/sponsor/sponsor.route'),
    propeventsRoutes = require('./components/propevents/propevents.route'),
    eventRoutes = require('./components/event/event.route'),
    inscriptionRoutes = require('./components/inscription/inscription.route'),
    fightRoutes = require('./components/fight/fight.route')
