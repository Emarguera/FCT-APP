...
(function(){
    ...
    var CalenderCtrl = function($scope, $timeout, picker, $mdMedia){
        ...
        self.startDay = angular.isUndefined($scope.weekStartDay) || $scope.weekStartDay==='' ? 'Domingo' : $scope.weekStartDay ;
...
(function(){
	...
	var TimePickerCtrl = function($scope, picker){
		...
		self.$scope = $scope;
		self.picker = picker;
		self.initialDate = $scope.initialTime;
		self.colorIntention = picker.colorIntention;
...
(function(){
    ...
    function DatePickerServiceCtrl($scope, $mdDialog, $mdMedia, $timeout, $mdUtil, picker){
        ...
        if(!angular.isUndefined(self.options) && (angular.isObject(self.options))){
            ...
            self.weekStartDay = isExist(self.options.weekStartDay, 'Domingo');
...
function picker(){
    ...
    var customRangeLabel = 'Rango de Fechas';
    ...
    var rangeCustomStartEnd =['Fecha Inicio', 'Fecha Finaliza'];
